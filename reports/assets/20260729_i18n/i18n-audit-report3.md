...
| base | line | lang | type | count | sample |
|---|---|---|---|---|---|
|  |  | cn | 日本語の中黒(U+30FB) | 36 | …收集以下个人信息。 (1) 通过企业网站咨询时 姓名 公司名称・团体名称 电子邮箱地址 咨询内容 咨询类别（您所选择的分类）… （他35件同種） |
|  |  | tw | 日本語の中黒(U+30FB) | 36 | …收集以下個人資訊。 (1) 透過企業網站諮詢時 姓名 公司名稱・團體名稱 電子郵件地址 諮詢內容 諮詢類別（您所選擇的分類）… （他35件同種） |
|  |  | ko | 日本語の中黒(U+30FB) | 2 | …개인정보의 유출, 멸실, 훼손 그 밖의 사태가 발생하거나 그 우려를 파악한 경우, 법령에 따라 필요한 조사・대응을 실시하고, 관계 기관에 대한 보고 및 본인에 대한 통지 등을 적절히 실시합니다.… （他1件同種） |
