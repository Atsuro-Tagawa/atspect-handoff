...
const WORDS = ['第一人者','代表する','代表的','中心的人物','中心人物','中心となった','重鎮','先駆的','先駆者','先駆','先がけ','さきがけ','先達','確立者','主導し','を主導','主導的','指導的','牽引','けん引','草分け','旗手','立役者','泰斗','大御所','巨頭','巨匠','大家','随一','屈指','最高峰','第一級','第一線','最前線','牽引者','担い手として','旗頭','立て役者','一流','権威','双璧','正統','本流','頂点','名家','重要人物','重要作家'];
const out = [];
