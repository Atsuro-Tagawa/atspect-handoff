...
export const RANK = {
  ja: ['第一人者','代表する','代表的','中心的人物','中心人物','中心となった','重鎮','先駆的','先駆者','先駆','先がけ','さきがけ','先達','確立者','主導し','を主導','主導的','指導的','牽引','牽引者','けん引','草分け','旗手','旗頭','立役者','立て役者','泰斗','大御所','巨頭','巨匠','大家','随一','屈指','最高峰','第一級','第一線','最前線','一流','権威','双璧','正統','本流','頂点','名家','重要人物','重要作家'],
  en: ['leading','foremost','pioneer','pioneering','led the','spearhead','headed','central figure','major figure','important figure','key figure','representative of','master of','preeminent','prominent','the first to','forefront','vanguard','trailblaz','doyen','luminary','towering'],
  zh_cn: ['代表','主导','先驱','引领','中心人物','重要人物','巨匠','泰斗','重镇','首屈一指','开拓者','前沿','领军','领袖','翘楚','权威','第一人','奠基人','鼻祖','大师'],
  zh_tw: ['代表','主導','先驅','引領','中心人物','重要人物','巨匠','泰斗','重鎮','首屈一指','開拓者','前沿','領軍','領袖','翹楚','權威','第一人','奠基人','鼻祖','大師'],
  ko: ['대표하는','대표적','주도','선구','선구자','선구적','견인','중심인물','중요 인물','거장','일인자','이끈','이끌었','최전선','선두','권위자','대가','태두','개척자'],
  fr: ['figure de proue','pionnier','pionnière','chef de file','mena','dirigea','figure centrale','figure importante','figure majeure','représentatif','maître de','à l\'avant-garde','fer de lance','sommité','éminent'],
  es: ['pionero','pionera','figura central','figura destacada','figura clave','lideró','dirigió','encabezó','representativo','maestro de','a la vanguardia','referente','eminente','máximo exponente'],
  de: ['führend','Wegbereiter','Pionier','führte an','anführte','zentrale Figur','bedeutende Persönlichkeit','Meister der','an der Spitze','Vorreiter','Koryphäe','maßgeblich','herausragend'],
};
